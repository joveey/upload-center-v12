                ...
                <div class="p-6 space-y-4">
                    <form method="GET" action="{{ route('legacy.format.index', $mapping->id) }}" class="flex flex-col md:flex-row md:items-center md:space-x-3 space-y-3 md:space-y-0">
                        ...
                        <div class="flex space-x-2">
                            <a href="{{ route('legacy.format.index', $mapping->id) }}" class="inline-flex items-center px-4 py-2.5 border border-gray-300 rounded-lg text-sm font-semibold text-gray-700 bg-white hover:bg-gray-50 transition-colors duration-150">
                                Reset
                            </a>
