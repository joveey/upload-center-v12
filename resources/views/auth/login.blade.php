    ...
    <form method="POST" action="{{ route('login') }}" class="space-y-6">
        ...
        <div class="group">
            ...
            <div class="relative">
                ...
                <x-text-input id="email" class="block w-full pl-12 pr-4 py-3 border-gray-300 focus:border-[#0057b7] focus:ring-2 focus:ring-[#0057b7]/20 rounded-xl shadow-sm transition-all duration-200" type="email" name="email" :value="old('email')" required autofocus autocomplete="username" placeholder="nama@example.com" />
            </div>
        ...
        <div class="group">
            ...
            <div class="relative">
                ...
                <x-text-input id="password" class="block w-full pl-12 pr-4 py-3 border-gray-300 focus:border-[#0057b7] focus:ring-2 focus:ring-[#0057b7]/20 rounded-xl shadow-sm transition-all duration-200" type="password" name="password" required autocomplete="current-password" placeholder="********" />
            </div>
        ...
        <div class="space-y-4">
            <button type="submit" class="group relative w-full flex justify-center items-center px-6 py-3.5 bg-gradient-to-r from-[#0057b7] via-[#006ad6] to-[#00a1e4] border border-transparent rounded-xl font-bold text-sm text-white uppercase tracking-wide hover:from-[#004a99] hover:via-[#0057b7] hover:to-[#0091cf] focus:outline-none focus:ring-4 focus:ring-[#0057b7]/40 transition-all duration-300 shadow-lg hover:shadow-2xl hover:-translate-y-0.5 transform">
            ...
            <div class="text-center p-4 bg-gradient-to-r from-[#e8f1fb] via-[#e8f1fb] to-[#e8f1fb] rounded-xl border border-[#c7d9f3]">
                ...
                <a href="{{ route('register') }}" class="text-sm font-bold text-transparent bg-clip-text bg-gradient-to-r from-[#004a99] to-[#00a1e4] hover:from-[#003b7a] hover:to-[#0091cf] ml-1 inline-flex items-center group transition-all duration-200">
                    Daftar sekarang
